(function () {
  ...
  var translations = {
    de: {
      ...
      'benefit5-title': 'Regionale Verankerung & Internationalität',
      'benefit5-text': 'Regional und überregional bekannt und geschätzt.',
      ...
      'contact-text': 'Kontaktieren Sie ihn gerne für ein <strong>unverbindliches Angebot</strong>. Gemeinsam finden wir die passende musikalische Lösung für Ihren Anlass.',
    ...
    en: {
      ...
      'benefit5-title': 'Regional Roots & International Reach',
      'benefit5-text': 'Known and appreciated both regionally and beyond.',
      ...
      'contact-text': 'Feel free to contact him for a <strong>no-obligation quote</strong>. Together we will find the perfect musical solution for your occasion.',
      'footer': '© 2026 Dieter Mross'
    },
    es: {
      ...
      'about-p2': 'Su espectro musical es extraordinariamente amplio: desde el <strong>Swing</strong> clásico y el <strong>Latin</strong> hasta la <strong>Bossa Nova</strong> y el <strong>Blues</strong>, pasando por arreglos pop modernos y música de cine. Ya sea como solista, en dúo o con banda completa – Dieter Mross adapta su repertorio flexiblemente a la ocasión y al ambiente deseado.',
      ...
      'benefit5-title': 'Raíces regionales y alcance internacional',
      'benefit5-text': 'Conocido y apreciado tanto regional como internacionalmente.',
      ...
      'contact-text': 'No dude en contactarlo para un <strong>presupuesto sin compromiso</strong>. Juntos encontraremos la solución musical adecuada para su ocasión.',
      'footer': '© 2026 Dieter Mross'
    }
  };
